...
function textOnChange(event: InputEvent, item: PostItem) {
...
<template>
    <Block>
        ...
        <br/>
        <br/>
        <button class="btn btn-green full-width" @click="createPostClick"> Submit </button>
    </Block>
</template>
